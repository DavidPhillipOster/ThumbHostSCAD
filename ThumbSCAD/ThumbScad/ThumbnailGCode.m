...
NSData *HeadOfFile(NSURL *fileURL){
  ...
  static const NSInteger maxHead = 2000000;
...
NSImage *ThumbnailGCode(NSURL *s) {
  ...
  return ResizeImage(LargestIcon(IconsFromData(FromBase64s(ThumbnailBase64sFromData(data)))), @"scad");
}
